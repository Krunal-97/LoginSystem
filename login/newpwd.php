<?php 
session_start();
include '../includes/setnewpassword.php';
			...
			<nav>
				...
				<div  class="nav2">
					...
					<form action="<?= htmlspecialchars($_SERVER["PHP_SELF"]) ?>" method="POST">
						...
						<input type="password" name="newpassword" placeholder="Set new Password" autofocus>
						<span><?php echo $pwd_error; ?></span>
						</br></br>
						<button type="submit" name="submit">Done</button></br>
